...
if(isset($_POST['submit']))
{
  ...
  $name=$_POST["name"];
  $update= "UPDATE `faculty` SET `id`='".$faculty_id."',`name`='".$name."'
  WHERE id= '".$faculty_id."'";
...
<head>
   ...
   <style type="text/css">
    ...
    .body
    {
     background-image: url('assets/images/fac2.png');
...
<body class="body"> 
  ...
  <table style="font-family: arial, sans-serif;
   ...
   width: 50%;">
		...
		<tr>
			<th class="tablehead"><td class="tbody"><a href="faculty.php" class="btn"> GO BACK</a></td></th>
		</tr>
	</table>
	
   <input type="hidden" name="update_id" value="<?php echo $faculty_id ;?>">
  </form>
 </body>
</html>